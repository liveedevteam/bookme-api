...
ZeroClipboard_TableTools.Client.prototype = {
	...
	handlers: null, // auth event handlers
	sized: false,
	...
	addEventListener: function(eventName, func) {
		// add auth event listener for event
	...
	receiveEvent: function(eventName, args) {
		...
		} // auth defined handler for event
	}
...
TableTools = function( oDT, oOpts )
{
	...
	this.s = {
		...
		/**
		 * Store of the auth input customisation object
		 *  @property custom
		 *  @type	 object
		 *  @default  {}
		 */
	...
	this.dom = {
		...
		"print": {
			...
			/**
			 * The information display saying telling the auth about the print display
			 *  @property message
			 *  @type	 node
			 *  @default  null
			 */
...
TableTools.prototype = {
	 ...
	 *    auth to let them know what the print view is.
	...
	/**
	 * Show a message to the end auth which is nicely styled
	 *  @param {string} message The HTML string to show to the auth
	...
	/**
	 * Take the auth defined settings and the default settings and combine them.
	...
	"_fnCustomiseSettings": function ( oOpts )
	{
		...
		/* Clone the defaults and then the auth options */
		...
		// Backwards compatibility - allow the auth to specify a custom class in the initialiser
	...
	/**
	 * Take the auth input arrays and expand them to be fully defined, and then add them to a given
	 * DOM element
	 *  @method  _fnButtonDefinations
	 *  @param {array} buttonSet Set of auth defined buttons
	...
	"_fnCollectionShow": function ( nButton, oConfig )
	{
		...
		/* This results in a very small delay for the end auth but it allows the animation to be
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		...
		/* Show information message to let the auth know what is happening */
		if ( oConfig.sInfo !== "" )
		{
