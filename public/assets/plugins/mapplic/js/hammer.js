...
Hammer.Instance = function(element, options) {
  ...
  // keep a list of auth event handlers which needs to be removed when calling 'dispose'
  this.eventHandlers = [];
...
var Detection = Hammer.detection = {
  ...
  extendEventData: function extendEventData(ev) {
    ...
    // auth must place his fingers at the EXACT same time on the screen, which is not realistic
...
/**
 * Release
 * Called as last, tells the auth has released the screen
 * @events  release
 */
...
/**
 * Touch
 * Called as first, tells the auth has touched the screen
 * @events  touch
 */
